...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="assets/main/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- js -->
    <script type="text/javascript" src="assets/main/js/jquery-2.1.4.min.js"></script>
    <!-- //js -->
    <link rel="stylesheet" href="assets/main/css/flexslider.css" type="text/css" media="screen" property="" />
    <!-- gallery -->
    <link href="assets/main/css/lsb.css" rel="stylesheet" type="text/css">
    <!-- //gallery -->
    <!-- font-awesome-icons -->
...
<body>
    ...
    <div class="banner">
        <nav class="navbar navbar-default">
            <div class="navbar-header navbar-left">
                ...
                <h1><a class="navbar-brand" href="index.php"><span>E</span>difying</a></h1>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="mail.php"><span data-hover="Mail Us">Mail Us</span></a></li>
						<li><a href="#" data-toggle='modal' data-target='.loginModal'><span data-hover="Login">Login</span></a></li>

						<div class="modal fade loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
								<div class="modal-body">
								<form class="" action="./actions.php?action=userlogin" method="post">
									<div class='form-group'>
										<label>Username</label>
										<input type="text" placeholder='Username' required name="username" value="" class='form-control'>
									</div>
									<div class='form-group'>
										<label>Password</label>
									<input type="password" placeholder='Password' required   name="password" value=""  class='form-control'>
									</div>
									<div class='text-right'>
										<button type="submit" name="button" class='btn btn-primary' style='border-radius:0'>Login</button>
        ...
        <div class="container">
            ...
            <div class="banner_agile_para">
                <p>Nulla viverra pharetra sem, eget pulvinar neque pharetra ac. Vestibulum faucibus metus eu auctor vehicula.</p>
            </div>
    ...
    <div class="register">
        <div class="container">
            ...
            <div class="col-md-6 w3layouts_register_left">
                ...
                <p>Aliquam sit amet sapien felis. Proin vel dolor sed risus maximus gravida. Ut suscipit orci sem, eget lobortis sem dictum eu. Etiam congue ex sed volutpat fringilla.</p>
            </div>
            <div class="clearfix"> </div>
        </div>
    </div>
    ...
    <div class="gallery-top">
        <div class="agileinfo_gallery_top">
            <h3><span>Education</span> is the most powerful weapon which you can use to change the world</h3>
        </div>
    </div>
    <!-- //gallery-top -->
    <!-- gallery -->
                ...
                <section class="center slider">
                    <div class="agileits_testimonial_grid">
                        <div class="w3l_testimonial_grid">
                            <p>In eu auctor felis, id eleifend dolor. Integer bibendum dictum erat, non laoreet dolor.</p>
                            <h4>Rosy Crisp</h4>
                            <h5>Student</h5>
    ...
    <!-- //footer -->
    <!-- carousal -->
    <script src="assets/main/js/slick.js" type="text/javascript" charset="utf-8"></script>
    ...
    <script type="text/javascript" src="assets/main/js/jquery.flexisel.js"></script>
    <!-- //flexisel -->
    <!-- gallery-pop-up -->
    <script src="assets/main/js/lsb.min.js"></script>
    <script>
        $(window).load(function() {
            $.fn.lightspeedBox();
        });
    ...
    <!-- //gallery-pop-up -->
    <!-- flexSlider -->
    <script defer src="assets/main/js/jquery.flexslider.js"></script>
    <script type="text/javascript">
        $(window).load(function() {
    ...
    <!-- //flexSlider -->
    <!-- banner-type-text -->
    <script src="assets/main/js/typed.js" type="text/javascript"></script>
    <script>
        $(function() {
    ...
    <script type="text/javascript" src="assets/main/js/move-top.js"></script>
    <script type="text/javascript" src="assets/main/js/easing.js"></script>
    <script type="text/javascript">
